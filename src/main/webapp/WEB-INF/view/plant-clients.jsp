            ...
            <div class="col-4">
                <div class="list-group" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action btn-success" id="list-plant-list"
                       data-toggle="list"
                       href="#list-plant" role="tab" aria-controls="plant">${plant.id}. ${plant.name}
                        - ${plant.price}</a>
                </div>
            </div>
            <div class="col-8">
                <div class="tab-content" id="nav-tabContent">
                    <c:forEach var="tempPlant" items="${clients}">
                        <div class="tab-pane fade" id="list-plant" role="tabpanel" aria-labelledby="list-plant-list">
                            <li class="list-group-item">${tempPlant.id}. ${tempPlant.firstName} ${tempPlant.lastName}</li>
                        </div>
                    </c:forEach>
                </div>
            </div>
