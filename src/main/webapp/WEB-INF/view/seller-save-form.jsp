...
<div class="container">
    ...
    <div class="add-form">
        <form:form cssClass="save-form" action="${pageContext.request.contextPath}/seller/saveSeller"
                   modelAttribute="seller" method="post">
            <form:hidden path="id"/>

            <h2>Save New Seller</h2>
            <hr>
            ...
            <label>Adress</label>
            <div class="form-inline">
                <form:input cssClass="form-control mb-4 col-4 mr-2" placeholder="Address" path="address"/>
            ...
            <div>
                <a class="btn btn-success" href="${pageContext.request.contextPath}/seller/list">Back</a>
