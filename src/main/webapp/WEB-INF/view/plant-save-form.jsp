...
<div class="container">
    ...
    <div class="add-form">
        <form:form cssClass="save-form" action="${pageContext.request.contextPath}/plant/savePlant"
                   modelAttribute="plant" method="post">
            <form:hidden path="id"/>

            <h2>Save New Plant</h2>
            <hr>
            ...
            <div>
                ...
                <div class="form-inline">
                    <form:input cssClass="form-control mb-4 col-6 mr-2" placeholder="Family" path="description.family"/>
                    <form:errors cssClass="error" path="description.family"/>
                </div>

                <label for="exampleFormControlTextarea1">Hardiness</label>
                <div class="form-inline">
                    <form:textarea cssClass="form-control mb-4 col-10 mr-2" placeholder="Hardiness"
                                   path="description.hardiness"
                                   id="exampleFormControlTextarea1" rows="3"/>
                    <form:errors cssClass="error" path="description.hardiness"/>
                </div>

                <label for="exampleFormControlTextarea1">Use</label>
                <div class="form-inline">
                    <form:textarea cssClass="form-control mb-4 col-10 mr-2" placeholder="Use" path="description.use"
                                   id="exampleFormControlTextarea1" rows="2"/>
                    <form:errors cssClass="error" path="description.use"/>
                </div>

                <label for="exampleFormControlTextarea1">Cautions</label>

                <div class="form-inline">
                    <form:textarea cssClass="form-control mb-4 col-10 mr-2" placeholder="Coutions"
                                   path="description.cautions"
                                   id="exampleFormControlTextarea1" rows="2"/>
                    <form:errors cssClass="error" path="description.cautions"/>
                </div>
            </div>
