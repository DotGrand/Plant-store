        ...
        <div class="row">
            <div class="col-4">
                <div class="list-group" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action btn-success active" id="list-order-list"
                       data-toggle="list"
                       href="#list-order" role="tab" aria-controls="order">Order</a>
                    <a class="list-group-item list-group-item-action btn-success" id="list-plant-list"
                       data-toggle="list"
                       href="#list-plant" role="tab" aria-controls="plant">Plant</a>
                    <a class="list-group-item list-group-item-action btn-success" id="list-client-list"
                       data-toggle="list"
                       href="#list-client" role="tab" aria-controls="client">Client</a>
                </div>
            </div>
            <div class="col-8">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-order" role="tabpanel"
                        ...
                        <h3>Order</h3>
                        <li class="list-group-item"><b>Id: </b>${order.orderId}</li>
                        <li class="list-group-item"><b>Status: </b>${order.status}</li>
                        <li class="list-group-item"><b>Date of Order: </b>${order.dateOfOrder}</li>
                    </div>
                    <div class="tab-pane fade" id="list-plant" role="tabpanel" aria-labelledby="list-plant-list">
                        <h3>Plant</h3>
                        <li class="list-group-item"><b>Id: </b>${plant.id}</li>
                        <li class="list-group-item"><b>Name: </b> ${plant.name}</li>
                        <li class="list-group-item"><b>Family: </b> ${plant.description.family}</li>
                        <li class="list-group-item"><b>Hardiness: </b> ${plant.description.hardiness}</li>
                        <li class="list-group-item"><b>Use: </b> ${plant.description.use}</li>
                        <li class="list-group-item"><b>Cautions: </b> ${plant.description.cautions}</li>
                        <li class="list-group-item"><b>Price: </b> ${plant.price}</li>
                        <li class="list-group-item"><b>Quantity: </b> ${plant.quantity}</li>
                    </div>
                    <div class="tab-pane fade" id="list-client" role="tabpanel" aria-labelledby="list-client-list">
                        ...
                        <li class="list-group-item"><b>Name: </b>${client.firstName} ${client.lastName}</li>
                    </div>
                </div>
            </div>
        </div>
        <br>
        <a class="btn btn-success" href="${pageContext.request.contextPath}/order/list">Back</a>
    </div>
</div>
