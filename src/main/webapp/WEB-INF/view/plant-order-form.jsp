...
<div class="container">
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar navbar-light" style="background-color: #ffbb48;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <security:authorize access="hasRole('ADMIN')">
                <a style="margin-left: 650px" href="${pageContext.request.contextPath}/register/showRegistrationForm"
            ...
            <div style="margin-left: 90px"><security:authentication property="principal.username"/>
    ...
    <div class="add-form add-detail-form">
        <h2>Order Plant</h2>
        <hr>
        <!-- Save Order Plant Form -->
        <form:form action="${pageContext.request.contextPath}/plant/savePlantOrder" modelAttribute="orderInfo"
                   method="post">
            <form:hidden path="plant.id"/>

            <div class="form-group">
                Plant: <b>${orderInfo.plant.name}</b>
            </div>

            <div class="form-group">
                <label>Client id:</label>
                <form:input cssClass="form-control mb-4 col-4" path="client.id"/>
            </div>
