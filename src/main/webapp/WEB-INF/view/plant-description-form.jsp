        ...
        <div class="row">
            <div class="col-4">
                <div class="list-group" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action btn-success active" id="list-plant-list"
                       data-toggle="list"
                       href="#list-plant" role="tab" aria-controls="plant">${plant.id}. ${plant.name}</a>
                </div>
            </div>
            <div class="col-8">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-plant" role="tabpanel"
                         aria-labelledby="list-plant-list">
                        <h4>Family</h4>
                        <li class="list-group-item">${description.family}</li>
                        <br>
                        <h4>Hardiness</h4>
                        <li class="list-group-item">${description.hardiness}</li>
                        <br>
                        <h4>Use</h4>
                        <li class="list-group-item">${plant.description.use}</li>
                        <br>
                        <h4>Cautions</h4>
                        <li class="list-group-item">${plant.description.cautions}</li>
                    </div>
                </div>
            </div>
        </div>
